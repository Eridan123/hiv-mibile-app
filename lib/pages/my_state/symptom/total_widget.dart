            ...
            child: ListView.separated(
                itemBuilder: (context, index){
                  return ListTile(
                    ...
                    trailing: Text(_list[index].count ==1 ?_list[index].count.toString() +' '+ 'day'.tr() : _list[index].count<5 ?_list[index].count.toString() +' '+ 'days1'.tr() : _list[index].count.toString() + 'days2',
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                      ),
